...
class RegistrarAdminController extends AbstractAdminController implements Loadable {
    ...
    function bhaa_admin_registrar_page() {
        ...
        include_once('partials/bhaa_admin_registrar.php');
    }
    ...
    function bhaa_admin_registrar_monthly_page() {
        ...
        include_once('partials/bhaa_admin_registrar_monthly.php');
    }
