<div class="container-fluid">
    <div class="row row-striped">
        ...
        <div class="col-sm-1" title="{{category}}{{gender}} {{posincat}}/{{posinstd}}">Cat</div>
        <div class="col-sm-2">Company</div>
        <div class="col-sm-1" title="Standard - Actual - Post Standard">Std</div>
    ...
    <div class="row row-striped" id="{{id}}">
        ...
        <div class="col-sm-1">{{category}}{{gender}} {{posincat}}/{{posinstd}}</div>
        <div class="col-sm-2"><a class="bhaa-url-link" href="/?post_type=house&p={{cid}}">{{cname}}</a></div>
        <div class="col-sm-1">{{standard}}->[{{actualstandard}}]->{{poststandard}}</div>
