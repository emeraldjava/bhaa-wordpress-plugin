...
class IndividualLeague extends AbstractLeague implements League {
    ...
    function exportLeagueTopTen() {
        $SQL = $this->wpdb->prepare('select leaguedivision,leagueposition,leaguepoints,leaguescorecount as racesran,u.user_nicename,fn.meta_value,
